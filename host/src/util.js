// 公共工具：uuid16 生成、凭据读写（~/.acp-host/credentials.json，0600）
...
export const env = {
  serverUrl: process.env.SERVER_URL || 'http://127.0.0.1:11000',
  mqttUrl: process.env.ACP_MQTT_URL || 'mqtt://127.0.0.1:11200',
